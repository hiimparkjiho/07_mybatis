...
public class Application {
    ...
    public static void main(String[] args){
        ...
        * unpooledDateSource : ConnectionPool을 사용하지 않음
        * */
        ...
        org.apache.ibatis.session.Configuration config = new Configuration(environment);
        ...
        * Build() : 설정에 대한 정보를 담고 있는 Configuration타입의 객체 혹은 외부 설정 파일과 연결된 Stream을 매개변수로 전달하면
        ...
        * - false : connection 인터페이스 타입 객체로 Dml(update, insert, delete) 수행 후 Auto Commit에 대한 옵션을 false로 지정
